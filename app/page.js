    ...
    <div className="space-y-2">
      {links.map((link, index) => (
        <a
          ...
          className="group flex items-center text-teal-600 hover:text-teal-800 transition-colors"
        >
          {link.name}
          <ArrowRight 
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-6 p-8 pt-0">
            {[
              ...
              },
              {
                ...
                icon: <Brain className="w-12 h-12 text-teal-600 mx-auto mb-4" />,
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group-hover:text-teal-800 text-teal-600 flex items-center justify-center"
                >
                  Explore
