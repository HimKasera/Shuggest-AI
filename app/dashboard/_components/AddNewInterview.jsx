...
const TECH_STACK_SUGGESTIONS = {
  ...
  'QA Engineer': 'Selenium, Cypress, JUnit, TestNG, Postman'
};
...
function AddNewInterview() {
  ...
  const onSubmit = async (e) => {
    ...
    // const inputPrompt = `Job position: ${jobPosition}, Job Description: ${jobDescription}, Years of Experience: ${jobExperience}. Generate ${process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT} interview questions and answers in JSON format.`;
      const InputPrompt ="Job Position:" +jobPosition+", Job Description: "+jobDescription+", Years of Experience: "+year+", Depends on this information please give us "+process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT+" Interview question with Answered in Json Format, Give Question and Answered as field in JSON Format";
    try {
      const result = await chatSession.sendMessage(InputPrompt);
      const responseText = await result.response.text();
  
      // Remove potential JSON formatting characters
