      ...
      >
        ...
        <div className="md:hidden">
          <button
            ...
            className="focus:outline-none text-cyan-400 hover:text-cyan-300 transition-colors"
    ...
    <Link
      ...
      className={`
        ...
        ${mobile
          ...
          : "px-3 py-2 hover:bg-teal-800 hover:text-cyan-400"
        }
        ${path === href
          ? "text-cyan-400 font-bold bg-teal-800"
