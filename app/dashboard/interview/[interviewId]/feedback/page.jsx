...
const Feedback = ({ params }) => {
  ...
  const getRatingColor = (rating) => {
    ...
    if (numRating >= 8) return "text-teal-600";
    if (numRating >= 5) return "text-blue-600";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <Activity className="mx-auto h-12 w-12 text-teal-600 animate-pulse" />
      ...
      {feedbackList.length === 0 ? (
        <Card className="max-w-md mx-auto">
          <CardHeader className="text-center">
            <XCircle className="mx-auto h-16 w-16 text-purple-600" />
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <Card>
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-teal-600">Great Job!</h2>
                ...
                <CollapsibleContent className="p-4 bg-white">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="bg-purple-50 p-3 rounded-lg text-sm text-purple-900 border border-purple-200">
                        {item.userAns || "No answer provided"}
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-700 mb-2">Correct Answer</h4>
                      <p className="bg-teal-50 p-3 rounded-lg text-sm text-teal-900 border border-teal-200">
                        {item.correctAns}
                      </p>
                    </div>
                  </div>
                  <div className="mt-4">
                    ...
                    <p className="bg-blue-50 p-3 rounded-lg text-sm text-blue-900 border border-blue-200">
                      {item.feedback}
                    </p>
                  </div>
